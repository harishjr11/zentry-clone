...
export const Hero = () => {
    ...
    const upcmomingVideoIndex = (currentIndex % totalVideos) + 1;
    ...
    const handleMiniVdClick = () => {
        ...
        setCurrentIndex(upcmomingVideoIndex);
    }
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
        ...
        <div id='video-frame' className='relative z-10 w-screen h-dvh
        overflow-hidden rounded-lg bg-blue-75'>
            <div>
                ...
                absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
                    ...
                    <video 
                    ref={nextVideoRef}
                    src={getVideoSrc(upcmomingVideoIndex)} loop muted
                    id = 'current-video' 
            ...
            <h1 className='special-font hero-heading absolute bottom-10
            right-10 z-40 text-blue-75'>G<b>A</b>MING</h1>
        ...
        <h1 className='special-font hero-heading absolute bottom-10
            right-10 text-black'>G<b>A</b>MING</h1>
    </div>
  )
}
